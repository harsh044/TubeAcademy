...
exports.createSubSection = async (req, res) => {
    try {
        // extract data
        const { title, timeDuration, position, description, videoUrl, sectionId } = req.body;
        ...
        // validation
        if (!title || !timeDuration || !description || !position || !videoUrl || !sectionId) {
        ...
        const SubSectionDetails = await SubSection.create(
            { title, timeDuration, position, description, videoUrl})
