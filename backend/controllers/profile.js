...
exports.getEnrolledCourses = async (req, res) => {
    try {
            ...
            .populate({
                ...
                populate: {
                    ...
                    populate: {
                        path: "subSection",
                        options: {
                            sort: { position: 1 } // Sorting subSections by position in ascending order
                        },
                    },
                },
            })
        ...
        duration = userDetails.courses.totalDuration
        ...
        for (var i = 0; i < userDetails.courses.length; i++) {
            ...
            for (var j = 0; j < userDetails.courses[i].courseContent.length; j++) {
                ...
                userDetails.courses[i].Duration = userDetails.courses[i].totalDuration
