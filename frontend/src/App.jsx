...
import CertificateView from "./components/core/Dashboard/CertificateView";
  ...
  return (
    <div className="w-screen min-h-screen bg-richblack-900 flex flex-col font-inter">
      ...
      <button onClick={() => window.scrollTo(0, 0)}
        className={`bg-red-100 hover:bg-red-200 hover:scale-110 p-3 text-lg text-black rounded-2xl fixed right-3 z-10 duration-500 ease-in-out ${showArrow ? 'bottom-6' : '-bottom-24'} `} >
        <HiArrowNarrowUp />
      </button>
