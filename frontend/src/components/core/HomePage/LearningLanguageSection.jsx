    ...
    return (
        <div className='mt-[130px] mb-10'>
            <div className='flex flex-col gap-5 items-center'>
                ...
                In today’s globalized world, mastering multiple languages unlocks countless opportunities. With Spin, learning becomes effortless, engaging, and effective, empowering you to expand your skills and reach new heights.
                </div>
