...
const timeline = [
    {
        Logo: Logo1,
        heading: "Leadership",
        Description: "Fully dedicated to the company's success.",
    },
    {
        Logo: Logo2,
        heading: "Responsibility",
        Description: "Students will always be our highest priority.",
    },
    {
        Logo: Logo3,
        heading: "Flexibility",
        Description: "The ability to adapt is an important skill.",
    },

    {
        Logo: Logo4,
        heading: "Solve the problem",
        Description: "Program your way to a solution.",
    },
];
