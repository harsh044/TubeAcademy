    ...
    <div>
      <div className='flex flex-col-reverse lg:flex-row gap-10 lg:gap-20 items-center'>
        ...
        <div className='lg:w-[50%] flex flex-col'>
          ...
          Instructors from across the globe teach millions of students on TubeAcademy. We equip you with the tools and skills to teach what you’re passionate about, empowering you to share your expertise with a global audience.
          </p>
